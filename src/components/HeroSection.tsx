...
import heroDiorama from "@/assets/IMG_9848-2.PNG";
          ...
          <div className="max-w-7xl mx-auto w-full">
            <div className="hero-container overflow-hidden rounded-[2rem] shadow-premium">
              <div className="grid md:grid-cols-2 min-h-[560px]">
                ...
                <div className="relative flex items-center justify-center overflow-hidden min-h-[320px] md:min-h-auto bg-graphite">
                  <img
                    src={heroDiorama}
                ...
                {/* Right: Content */}
                <div className="flex flex-col justify-between px-8 md:px-12 py-8 bg-graphite border-l-2 border-emerald-brand/40 min-h-[560px]">
                  <div>
