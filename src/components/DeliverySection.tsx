...
import planeSrc from "@/assets/delivery-routes/IMG_9851.png";
import expressSrc from "@/assets/delivery-routes/IMG_9852-2.png";
import trainSrc from "@/assets/delivery-routes/IMG_9854-2.png";
import truckSrc from "@/assets/delivery-routes/IMG_9855.PNG";
import shipSrc from "@/assets/delivery-routes/IMG_98356.png";
...
export default function DeliverySection() {
  ...
  return (
    <section id="delivery" className="pt-[0.8cm] pb-[1.2cm] px-6 md:px-8 bg-milk">
