...
import videoControl from "@/assets/videos/IMG_9774.MP4";
import videoControl2 from "@/assets/videos/IMG_9777.MP4";
import videoWarehouse from "@/assets/videos/IMG_9778.MP4";
import videoProcess from "@/assets/videos/IMG_6290.MP4";
...
export default function WhySection() {
  ...
  return (
    <section id="why" className="pt-[0.8cm] pb-[1.2cm] px-6 md:px-8 bg-milk">
