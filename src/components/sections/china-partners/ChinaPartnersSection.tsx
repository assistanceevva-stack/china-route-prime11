import partnersBg from "@/assets/sections/china-partners/partners-bg.png";
...
export default function ChinaPartnersSection() {
  return (
    <section id="partners" className="relative pt-[0.8cm] pb-[0.8cm] px-6 md:px-8 overflow-hidden" aria-label="Партнёры и площадки Китая">
      <img
        src={partnersBg}
        alt=""
        loading="lazy"
